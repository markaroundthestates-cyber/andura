...
// LOCKED V1 per §36.16-§36.26 SUFLET ANDURA + §36.44 (T0 hard minimum) + §36.45 (T2 wording funcțional).
...
export const TIER_LEVELS = {
  T0: { id: 0, label: 'Pornire rapidă',          requirements: 'Skip onboarding · engine generic + demographic prior' },
  T1: { id: 1, label: 'Profil de bază',          requirements: 'Profile Typing complete (chestionar T1+)' },
  T2: { id: 2, label: 'Profil + vitalitate',     requirements: 'T1 + vitality data adăugată' },
 ...
 * Engines respect tier gating to prevent false positives la sesiuni puține.

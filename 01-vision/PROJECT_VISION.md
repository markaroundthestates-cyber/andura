...
> **Coach-ul nu urmează un program. Coach-ul urmează corpul.**

Toate deciziile motor pleacă de aici. Dacă se propune un feature care contrazice principiul, se refuză.
...
## VIZIUNEA DECIZIONALĂ

Engine-ul înțelege context complet:
- **User onest** — împinge pe date reale
- **User mincinos/lazy** — detectează discrepanțe, propune test
- **User confuz** — acceptă variații fără a judeca
- **User stressed** — identifică semnale, ajustează load
- **User post-injury** — recovery protocol automat
- **User motivat** — capitalizează pe momentum

Engine-ul explică logic fiecare decizie (nu "black box").

---

## CITATE CARE DEFINESC VIZIUNEA
...
- **Free tier:** bază funcțională
- **Paid tier ($7-10/lună):** full features, health exports, multi-programe
- **Premium ($20+/lună):** coaching AI intensiv, analytics avansate

Post-launch — feedback-driven pricing.

---

## VALORI PRODUS

1. **Nu minți user-ul** — decizii transparente, zero black box
2. **Nu pierde date** — zero tolerance pe data loss

# ADR 009 AMENDMENT — Tier System SSOT (engine_tier + calibration_confidence ortogonale)

**Status:** Accepted
**Date:** 2026-04-29 (chat strategic Opus 4.7) → formalized 2026-04-30 Sprint 1 autonomous
**Amendment to:** [[009-calibration-tiers]]
...
- `03-decisions/009-calibration-tiers.md` (header — link la amendment)
...
*Amendment authored 2026-04-30 Sprint 1 autonomous run Opus 4.7. Sign-off implicit via handover lock 2026-04-29 chat strategic Daniel + Claude Opus.*

...
Replace toate occurences `99-archive/wiki-pre-2026-05-15/concepts/`, `99-archive/wiki-pre-2026-05-15/entities/`, `99-archive/wiki-pre-2026-05-15/summaries/`, `99-archive/wiki-pre-2026-05-15/sources/` în DECISIONS.md cu prefix `99-archive/wiki-pre-2026-05-15/`:
...
sed -i 's|99-archive/wiki-pre-2026-05-15/concepts/|99-archive/wiki-pre-2026-05-15/concepts/|g' DECISIONS.md
sed -i 's|99-archive/wiki-pre-2026-05-15/entities/|99-archive/wiki-pre-2026-05-15/entities/|g' DECISIONS.md
sed -i 's|99-archive/wiki-pre-2026-05-15/summaries/|99-archive/wiki-pre-2026-05-15/summaries/|g' DECISIONS.md
sed -i 's|99-archive/wiki-pre-2026-05-15/sources/|99-archive/wiki-pre-2026-05-15/sources/|g' DECISIONS.md
...
if [ -f 00-index/INDEX_MASTER.md ]; then
  sed -i 's|99-archive/wiki-pre-2026-05-15/concepts/|99-archive/wiki-pre-2026-05-15/concepts/|g' 00-index/INDEX_MASTER.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/entities/|99-archive/wiki-pre-2026-05-15/entities/|g' 00-index/INDEX_MASTER.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/summaries/|99-archive/wiki-pre-2026-05-15/summaries/|g' 00-index/INDEX_MASTER.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/sources/|99-archive/wiki-pre-2026-05-15/sources/|g' 00-index/INDEX_MASTER.md
fi

# VAULT_RULES.md sweep (if has wiki refs)
if [ -f VAULT_RULES.md ]; then
  sed -i 's|99-archive/wiki-pre-2026-05-15/concepts/|99-archive/wiki-pre-2026-05-15/concepts/|g' VAULT_RULES.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/entities/|99-archive/wiki-pre-2026-05-15/entities/|g' VAULT_RULES.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/summaries/|99-archive/wiki-pre-2026-05-15/summaries/|g' VAULT_RULES.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/sources/|99-archive/wiki-pre-2026-05-15/sources/|g' VAULT_RULES.md
fi

# CLAUDE.md root sweep (note: D001 declares root CLAUDE.md FROZEN, but cross-refs update is operational not semantic)
if [ -f CLAUDE.md ]; then
  sed -i 's|99-archive/wiki-pre-2026-05-15/concepts/|99-archive/wiki-pre-2026-05-15/concepts/|g' CLAUDE.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/entities/|99-archive/wiki-pre-2026-05-15/entities/|g' CLAUDE.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/summaries/|99-archive/wiki-pre-2026-05-15/summaries/|g' CLAUDE.md
  sed -i 's|99-archive/wiki-pre-2026-05-15/sources/|99-archive/wiki-pre-2026-05-15/sources/|g' CLAUDE.md
fi
```
...
grep -rln "wiki/concepts\|wiki/entities\|wiki/summaries\|wiki/sources" \
  ...
  --exclude-dir=reports \
  . | while read file; do
    sed -i 's|99-archive/wiki-pre-2026-05-15/concepts/|99-archive/wiki-pre-2026-05-15/concepts/|g' "$file"
    sed -i 's|99-archive/wiki-pre-2026-05-15/entities/|99-archive/wiki-pre-2026-05-15/entities/|g' "$file"
    sed -i 's|99-archive/wiki-pre-2026-05-15/summaries/|99-archive/wiki-pre-2026-05-15/summaries/|g' "$file"
    sed -i 's|99-archive/wiki-pre-2026-05-15/sources/|99-archive/wiki-pre-2026-05-15/sources/|g' "$file"
  done

...
export const PERSONAS = [
  ...
  p(13, 'Radu', '29 M 82kg shoulder-impingement upper-painfree+mass balanced 4d',
    ...
    { pain: 'shoulder', expectBackSafe: false }),
  ...
  p(15, 'Mihai', '35 M 90kg home(DB+bench+pullup) mass+back 4d',
    { age: 35, sex: 'm', goal: 'masa', frequency: '4', experience: 'intermediar', weight: 90, height: 183, focusPreset: 'back' }),
  ...
  p(23, 'Andreea', '35 F glutes+legs refuses-squat/deadlift 4d intermediate',
    { age: 35, sex: 'f', goal: 'masa', frequency: '4', experience: 'intermediar', weight: 66, height: 168, focusPreset: 'lower' },
    { note: 'refuses squat/deadlift → glute/leg work via machines/hinges' }),

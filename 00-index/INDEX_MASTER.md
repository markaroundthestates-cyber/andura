...
**Last updated:** 2026-05-08 — Faza 3 STRANGLER batch 1 Periodization wiring real LANDED — adapter D2 thin scope + featureFlag default OFF + Golden-master parity 3 fixture cases zero-behavior-change + Constraint Object immutable propagation + sub-span CDL telemetry (cumulative LOCKED V1 ~695 → ~696, +1 net product/architecture; primul adapter LANDED setează precedent pentru remaining 7).
